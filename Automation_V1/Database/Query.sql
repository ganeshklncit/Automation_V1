...
documentupload int, status int);

create table tblcontractdetails (contractdetailsid int, contractid int, contractselected varchar(100), status int);

create table tblcontractdocument (contractdetailsid int, contractid int, documentid int,documenturl varchar(255), status int);